...
const signup = z.object({
    ...
    .trim().min(3,{message:"Name should be More than 3 charecters"})
    ...
    phone: z
    .string({required_error:"name is Required"})
    .trim().min(10,{message:"Phone number should be of 10 digits"})
    .max(20,{message:"Phone Number should be smaller than 20 digits"}),

    password: z
    .string({required_error:"Password is Required"})
    .trim().min(5,{message:"Password should be More than 5 charecters"})
    .max(100,{message:"Password should be smaller than 100 charecters"})
});

// const signin = z.object({
//     email : z
//     .string({required_error:"Email Does Not match"})
//     .trim(),

//     password : z
//     .string({required_error:"Incorrect password"}).trim()
// });
